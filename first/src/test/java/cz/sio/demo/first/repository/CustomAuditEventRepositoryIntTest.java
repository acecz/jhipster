package cz.sio.demo.first.repository;

import cz.sio.demo.first.FirstApp;
import cz.sio.demo.first.config.Constants;
import cz.sio.demo.first.config.audit.AuditEventConverter;
import cz.sio.demo.first.domain.PersistentAuditEvent;
...
import static cz.sio.demo.first.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
