package cz.demo.ngsvr.repository;

import cz.demo.ngsvr.NgsvrApp;
import cz.demo.ngsvr.config.Constants;
import cz.demo.ngsvr.config.audit.AuditEventConverter;
import cz.demo.ngsvr.domain.PersistentAuditEvent;
...
import static cz.demo.ngsvr.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
