package cz.test.tms.web.rest;

import cz.test.tms.config.Constants;
import cz.test.tms.TmsApp;
import cz.test.tms.domain.Authority;
import cz.test.tms.domain.PersistentToken;
import cz.test.tms.domain.User;
import cz.test.tms.repository.AuthorityRepository;
import cz.test.tms.repository.PersistentTokenRepository;
import cz.test.tms.repository.UserRepository;
import cz.test.tms.security.AuthoritiesConstants;
import cz.test.tms.service.MailService;
import cz.test.tms.service.dto.UserDTO;
import cz.test.tms.web.rest.errors.ExceptionTranslator;
import cz.test.tms.web.rest.vm.KeyAndPasswordVM;
import cz.test.tms.web.rest.vm.ManagedUserVM;
import cz.test.tms.service.UserService;
